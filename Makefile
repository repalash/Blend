...
compile:
	...
	g++ -o main.out main.cpp shader_utils.cpp gl_utils.cpp camera.cpp vector3D.cpp world.cpp sphere.cpp triangle.cpp cylinder.cpp quadric.cpp renderengine.cpp color.cpp ray.cpp material.cpp ${CPPFLAGS} ${LDFLAGS} -std=c++11
